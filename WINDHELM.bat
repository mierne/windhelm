...
REM Copyright (C) 2021-2026 Mierne <ahoy@mierne.net>
...
:exploration_engine
call "%winLoc%\data\functions\exploration_engine\exploration_engine.bat"
goto :AUTOSAVE
...
ECHO ^| Damage: 9 ^| Resistance Type: Physical ^| Total Resistance: 0
