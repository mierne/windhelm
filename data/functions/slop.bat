...
SET "windhelm.item_long_sword_class=Blade"
...
SET "windhelm.item_short_sword_class=Blade"
...
SET "windhelm.item_great_axe_class=axe"
...
SET "windhelm.item_hand_axe_class=axe"
...
SET "windhelm.item_mace_class=blunt"
...
SET "windhelm.item_wooden_bow_class=ranged"
